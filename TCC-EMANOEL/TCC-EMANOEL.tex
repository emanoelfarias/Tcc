...
A doença de Parkinson (DP) é uma patologia neuro degenerativa crônica e de caráter progressivo que afeta principalmente o sistema motor causando rigidez muscular, tremor, alteração na postura e bradicinesia (lentidão ao executar movimentos). Além disso, a DP pode causar também outras manifestações como depressão, problemas no sono e distúrbios relacionados à memória \citeonline{limongi2001}.
